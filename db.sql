...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 28-08-2018 a las 06:08:58
...
-- Procedimientos
--
CREATE DEFINER=`root`@`localhost` PROCEDURE `getClient` (IN `doc` VARCHAR(100))  NO SQL
SELECT * FROM clientes WHERE documento = doc$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `getFlights` ()  NO SQL
SELECT f1.*, f2. nombre ciudad_origen, f3. nombre ciudad_destino
FROM
	vuelos f1 INNER JOIN ciudades f2 on f1 . idciudad_origen = f2 . idciudad
    INNER JOIN ciudades f3 on f1 . idciudad_destino = f3 . idciudad$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `getReservas` (IN `doc` VARCHAR(45))  NO SQL
SELECT f1.*, f2. nombre ciudad_origen, f3. nombre ciudad_destino
FROM
	vuelos f1 INNER JOIN ciudades f2 on f1 . idciudad_origen = f2 . idciudad
    INNER JOIN ciudades f3 on f1 . idciudad_destino = f3 . idciudad
    INNER JOIN reservas f4 on f1 . idvuelo = f4 . idvuelo 
WHERE
	f4 . idcliente = (select a1.idcliente from clientes a1 where a1.documento = doc)$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `insertClient` (IN `nombres` VARCHAR(45), IN `apellidos` VARCHAR(45), IN `documento` VARCHAR(45), IN `fechanacimiento` DATE, IN `correo` VARCHAR(100), IN `telefono` VARCHAR(50))  NO SQL
BEGIN

DECLARE last_id INT;

INSERT INTO clientes (nombres, apellidos, documento, fecha_nacimiento, correo, telefono)
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `insertReserva` (IN `idcliente` INT(11), IN `idvuelo` INT(11), IN `asientos` INT(11))  NO SQL
INSERT INTO reservas (idcliente, idvuelo, num_puestos)
VALUES(
	idcliente,
    idvuelo,
    asientos
...
INSERT INTO `ciudades` (`idciudad`, `nombre`, `abr`, `iddepartamento`) VALUES
(1, 'Abriaquí', '1', 5),
(2, 'Acacías', '1', 50),
(3, 'Acandí', '1', 27),
(4, 'Acevedo', '1', 41),
...
INSERT INTO `clientes` (`idcliente`, `nombres`, `apellidos`, `documento`, `fecha_nacimiento`, `correo`, `telefono`) VALUES
(1, 'Juan David', 'Benitez', '1025504854', '2018-08-15', 'jdbenitez05@gmail.com', '3057639479'),
(2, 'Daniela', 'Gaviria', '123456789', '1989-06-07', 'daniela@gmail.com', '3018043969'),
(3, 'Alejandra', 'Salguero', '987654321', '1986-06-10', 'alejandra@gmail.cm', '3059874561'),
(4, 'Alejandra', 'Cardona', '321654987', '1989-07-27', 'alejacardona@gmail.com', '3015805150'),
(5, 'Carlos', 'Romero', '8885216548', '1989-07-27', 'carlitos@gmail.com', '3015805555'),
(6, 'Andres', 'Bolivar', '8885216549', '1989-07-27', 'andresbolivar@gmail.com', '3015805222'),
(7, 'Javier', 'Santos', '8885216549', '1989-07-27', 'javiersantos@gmail.com', '3015805123'),
(8, 'Mario', 'Vargas', '8885216549', '1989-07-27', 'mariovargas@gmail.com', '3015805321'),
(9, 'Jose', 'Barrios', '8885235210', '1989-07-27', 'josebarrios@gmail.com', '3015807878'),
(10, 'Daniel', 'Florez', '8885231420', '1989-07-27', 'danielflorez@gmail.com', '3015802541'),
(11, 'Catalida', 'Andrade', '8885231421', '1989-07-27', 'catalinaandrade@gmail.com', '3015809856'),
(12, 'Juan', 'Benitez', '1045704541', '2009-01-07', 'jbenitez@gmail.com', '3057639479');
...
INSERT INTO `departamentos` (`iddepartamento`, `nombre`, `abr`) VALUES
(5, 'ANTIOQUIA', NULL),
(8, 'ATLÁNTICO', NULL),
(11, 'BOGOTÁ, D.C.', NULL),
(13, 'BOLÍVAR', NULL),
...
(85, 'CASANARE', NULL),
(86, 'PUTUMAYO', NULL),
(88, 'ARCHIPIÉLAGO DE SAN ANDRÉS, PROVIDENCIA Y SAN', NULL),
(91, 'AMAZONAS', NULL),
(94, 'GUAINÍA', NULL),
(95, 'GUAVIARE', NULL),
(97, 'VAUPÉS', NULL),
...
INSERT INTO `reservas` (`idreserva`, `idvuelo`, `idcliente`, `num_puestos`) VALUES
(1, 8, 11, 2),
(2, 8, 12, 2),
(3, 41, 1, 1);
...
CREATE TABLE `vuelos` (
  ...
  `idciudad_origen` int(11) NOT NULL,
...
INSERT INTO `vuelos` (`idvuelo`, `codigo`, `salida`, `llegada`, `idciudad_origen`, `idciudad_destino`, `capacidad`) VALUES
(1, 'BAQ1', '2018-08-28 06:00:00', '2018-08-28 07:00:00', 88, 107, 5),
(2, 'BAQ2', '2018-08-28 08:00:00', '2018-08-28 09:00:00', 88, 171, 8),
(8, 'BAQ3', '2018-08-28 08:00:00', '2018-08-28 09:00:00', 88, 877, 8),
(9, 'BAQ4', '2018-08-28 09:00:00', '2018-08-28 10:00:00', 88, 547, 8),
(10, 'BAQ5', '2018-08-28 10:00:00', '2018-08-28 11:00:00', 88, 118, 8),
(11, 'BAQ6', '2018-08-28 11:00:00', '2018-08-28 12:00:00', 88, 657, 8),
(12, 'BAQ7', '2018-08-28 13:00:00', '2018-08-28 14:00:00', 88, 1042, 8),
(41, 'CAT1', '2018-08-28 08:00:00', '2018-08-28 09:00:00', 171, 88, 8),
(42, 'CAT2', '2018-08-28 09:00:00', '2018-08-28 10:00:00', 171, 107, 8),
(43, 'CAT3', '2018-08-28 10:00:00', '2018-08-28 11:00:00', 171, 877, 8),
(44, 'CAT4', '2018-08-28 11:00:00', '2018-08-28 12:00:00', 171, 547, 8),
(45, 'CAT5', '2018-08-28 12:00:00', '2018-08-28 13:00:00', 171, 118, 8),
(46, 'CAT6', '2018-08-28 13:00:00', '2018-08-28 14:00:00', 171, 657, 8),
(47, 'CAT7', '2018-08-28 14:00:00', '2018-08-28 15:00:00', 171, 1042, 8),
(48, 'CAT11', '2018-08-29 08:00:00', '2018-08-29 09:00:00', 171, 88, 8),
(49, 'CAT12', '2018-08-29 09:00:00', '2018-08-29 10:00:00', 171, 107, 8),
(50, 'CAT13', '2018-08-29 10:00:00', '2018-08-29 11:00:00', 171, 877, 8),
(51, 'CAT14', '2018-08-29 11:00:00', '2018-08-29 12:00:00', 171, 547, 8),
(52, 'CAT15', '2018-08-29 12:00:00', '2018-08-29 13:00:00', 171, 118, 8),
(53, 'CAT16', '2018-08-29 13:00:00', '2018-08-29 14:00:00', 171, 657, 8),
(54, 'CAT17', '2018-08-29 14:00:00', '2018-08-29 15:00:00', 171, 1042, 8),
(55, 'CAT18', '2018-08-30 08:00:00', '2018-08-30 09:00:00', 171, 88, 8),
(56, 'CAT19', '2018-08-30 09:00:00', '2018-08-30 10:00:00', 171, 107, 8),
(57, 'CAT20', '2018-08-30 10:00:00', '2018-08-30 11:00:00', 171, 877, 8),
(58, 'CAT21', '2018-08-30 11:00:00', '2018-08-30 12:00:00', 171, 547, 8),
(59, 'CAT22', '2018-08-30 12:00:00', '2018-08-30 13:00:00', 171, 118, 8),
(60, 'CAT23', '2018-08-30 13:00:00', '2018-08-30 14:00:00', 171, 657, 8),
(61, 'CAT24', '2018-08-30 14:00:00', '2018-08-30 15:00:00', 171, 1042, 8),
(62, 'CAT25', '2018-08-31 08:00:00', '2018-08-31 09:00:00', 171, 88, 8),
(63, 'CAT26', '2018-08-31 09:00:00', '2018-08-31 10:00:00', 171, 107, 8),
(64, 'CAT27', '2018-08-31 10:00:00', '2018-08-31 11:00:00', 171, 877, 8),
(65, 'CAT28', '2018-08-31 11:00:00', '2018-08-31 12:00:00', 171, 547, 8),
(66, 'CAT29', '2018-08-31 12:00:00', '2018-08-31 13:00:00', 171, 118, 8),
(67, 'CAT30', '2018-08-31 13:00:00', '2018-08-31 14:00:00', 171, 657, 8),
(68, 'CAT31', '2018-08-31 14:00:00', '2018-08-31 15:00:00', 171, 1042, 8);
...
ALTER TABLE `ciudades`
  ...
  ADD KEY `fk_ciudades_departamentos` (`iddepartamento`);
...
ALTER TABLE `reservas`
  ...
  ADD KEY `fk_reservas_vuelos1` (`idvuelo`),
  ADD KEY `fk_reservas_clientes1` (`idcliente`);
...
ALTER TABLE `vuelos`
  ...
  ADD KEY `fk_vuelos_ciudades1` (`idciudad_origen`),
  ADD KEY `fk_vuelos_ciudades2` (`idciudad_destino`);
...
--
ALTER TABLE `ciudades`
  MODIFY `idciudad` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1101;
...
--
ALTER TABLE `vuelos`
  MODIFY `idvuelo` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=69;
...
--
ALTER TABLE `ciudades`
  ADD CONSTRAINT `fk_ciudades_departamentos` FOREIGN KEY (`iddepartamento`) REFERENCES `departamentos` (`iddepartamento`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Filtros para la tabla `reservas`
--
ALTER TABLE `reservas`
  ADD CONSTRAINT `fk_reservas_clientes1` FOREIGN KEY (`idcliente`) REFERENCES `clientes` (`idcliente`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_reservas_vuelos1` FOREIGN KEY (`idvuelo`) REFERENCES `vuelos` (`idvuelo`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Filtros para la tabla `vuelos`
--
ALTER TABLE `vuelos`
  ADD CONSTRAINT `fk_vuelos_ciudades1` FOREIGN KEY (`idciudad_origen`) REFERENCES `ciudades` (`idciudad`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_vuelos_ciudades2` FOREIGN KEY (`idciudad_destino`) REFERENCES `ciudades` (`idciudad`) ON DELETE NO ACTION ON UPDATE NO ACTION;
COMMIT;
